(function() {
    'use strict';
    // Плагин модифицирован. Добавленно переключение класса при работе анимации.
        ...
        function($rootScope, $timeout, $window) {
            return {
                    ...
                    return function(cancelled) {
                        ...
                        if (!cancelled) {
                            $timeout(function() {
                                ...
                                // Добавление в плагин
                                angular.element(document).find('body').removeClass('route-change-anim');
                            }, inSpeed);
                        }
                    };
                },
                leave: function(element, done) {
                    ...
                    // Добавление в плагин
                    angular.element(document).find('body').addClass('route-change-anim');
